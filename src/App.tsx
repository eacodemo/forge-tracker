      ...
      <div className="main">
        <div className="view-scroll">
          ...
          <Suspense fallback={<div className="view-loading">···</div>}>
            ...
            <ErrorBoundary name="FocusView">{view==="focus"&&<FocusView year={year} monthIdx={monthIdx} todayDay={todayDay} isCurrentMonth={isCurrentMonth} habits={habits} checks={checks} monthStats={monthStats} toggleCheck={toggleCheck} L={L} lang={lang}/>}</ErrorBoundary>
            <ErrorBoundary name="StatsView">{view==="stats"&&<StatsView monthIdx={monthIdx} year={year} monthName={monthName} daysInMonth={daysInMonth} habits={habits} checks={checks} monthStats={monthStats} L={L} lang={lang} theme={theme}/>}</ErrorBoundary>
